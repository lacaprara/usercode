...
for M in {225..345..5} {350..600..10}
do
  #echo $M
  bsub -o M$M.log -J M$M /lustre/cmswork/lacaprar/Ana/CMSSW_5_3_11/src/AZh/2HDM/test/MSSM/MSSM_mhmax_mu600/createMSSM_model.sh $M
  # mkdir Run_M$M
  # cd Run_M$M
